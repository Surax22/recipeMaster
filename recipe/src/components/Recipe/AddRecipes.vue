  ...
  <body>
    ...
    <div  class="submit-form">
      <form @submit.prevent="submit">
        ...
        <input class="button-primary  inline-block px-6 py-2.5
                     ...
                     rounded shadow-md bg-lime-600 hover:bg-lime-400 hover:shadow-lg  w-full mb-3" 
    ...
    <div class="flex items-center justify-between pb-6">
                    ...
                    <router-link to="Home_1" class="button-primary  inline-block px-6 py-2.5
                     text-white font-medium text-xs leading-tight uppercase 
                     rounded shadow-md bg-lime-600 hover:bg-lime-400 hover:shadow-lg  w-full text-center  mb-3">Recipes</router-link>
                    <!-- <router-view to="" class="btn btn-link" /> -->
                  </div>   
  </div>
                </div>
