import { User, IdToken, RedirectLoginOptions, PopupLoginOptions, PopupConfigOptions, RedirectLoginResult, GetTokenSilentlyOptions, GetTokenSilentlyVerboseResponse, GetTokenWithPopupOptions, LogoutUrlOptions, LogoutOptions } from '@auth0/auth0-spa-js';
import { Ref } from 'vue';
