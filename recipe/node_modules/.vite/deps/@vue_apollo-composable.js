...
// node_modules/@vue/apollo-composable/node_modules/throttle-debounce/esm/index.js
...
// node_modules/@apollo/client/node_modules/@wry/context/lib/context.esm.js
...
function getAppTracking() {
  ...
  const root2 = (_c = (_a5 = vm == null ? void 0 : vm.$root) != null ? _a5 : vm == null ? void 0 : vm.root) != null ? _c : (_b = vm == null ? void 0 : vm.proxy) == null ? void 0 : _b.$root;
  if (!root2) {
...
function useQueryImpl(document, variables, options = {}, lazy = false) {
  ...
  let firstResolve;
  let firstReject;
  vm && ((_a5 = onServerPrefetch) == null ? void 0 : _a5(() => {
    var _a22;
  ...
  function processNextResult(queryResult) {
    result2.value = queryResult.data && Object.keys(queryResult.data).length === 0 ? void 0 : queryResult.data;
...
function useSubscription(document, variables = void 0, options = {}) {
  ...
  function start() {
    ...
    started = true;
    loading.value = true;
    const client = resolveClient((_a5 = currentOptions.value) == null ? void 0 : _a5.clientId);
  ...
  function onNextResult(fetchResult) {
    result2.value = fetchResult.data;
    loading.value = false;
  ...
  function updateRestartFn() {
    var _a5, _b;
    if ((_a5 = currentOptions.value) == null ? void 0 : _a5.throttle) {
      debouncedRestart = throttle(currentOptions.value.throttle, baseRestart);
    } else if ((_b = currentOptions.value) == null ? void 0 : _b.debounce) {
      debouncedRestart = debounce(currentOptions.value.debounce, baseRestart);
    } else {
...
function useResult(result2, defaultValue, pick) {
